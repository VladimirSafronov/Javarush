...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getPopulatedList() {
            List<PhantomReference<Monkey>> phantomMonkeys = new ArrayList<>();
            for (int i = 0; i < 200; i++) {
                phantomMonkeys.add(new PhantomReference<Monkey>(new Monkey(), helper.getQueue()));
            }
            return phantomMonkeys;
        }
