    ...
    public static void runWorkingProcess() {
        for (Astronaut astronaut : astronauts) {
            if (astronaut instanceof Human) {
                pilot((Human) astronauts.get(astronauts.indexOf(astronaut)));
            }
            else if (astronaut instanceof Dog) {
                createDirection((Dog) astronauts.get(astronauts.indexOf(astronaut)));
            }
            else if (astronaut instanceof Cat) {
                research((Cat) astronauts.get(astronauts.indexOf(astronaut)));
            }
        }
    }
